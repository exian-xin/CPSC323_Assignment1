...
int main()
{
	...
	{
		int lengthofString = input.length(); // Get length of 'input'
...
referenced as such:
				 char num  '!' sep '.' ops
	new(0)			1,	2,	4,	0,	0,	0,
	string(1)		1,	1,	4,	0,	0,	0,
	int(2)			5,	2,	4,	0,	3,	0,
	float(3)		5,	3,	4,	0,	5,	0,
	comment(4)		4,	4,	0,	4,	4,	4,
 	invalid(5)		0,	0,	0,	0,	0,	0
*/
int testChar(char ch, int state)
{
	...
	else if (ch == Ops_Seps_list[20]) //[20] == '!'
	{
		currentState = FSM[currentState][2];
		return currentState;
	}
